            ...
            <div className='divide-y divide-warm-gray-200'>
              ...
              >
                ...
                <div className='mt-8 grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-12 lg:col-span-2 lg:mt-0'>
                  <p className='mx-auto mt-3 lg:mt-0 max-w-4xl text-2xl text-slate-800 lg:col-span-2'>
                    GreenBlue is an environmental nonprofit dedicated to
                    empowering a diversity of stakeholders to promote a more
                    sustainable materials economy. Their{' '}
                    <strong>mission</strong> is to foster the creation of a
                    resilient system of commerce based on the principles of
          ...
          <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
            <div className='space-y-8 xl:col-span-1'>
              ...
              <p className='text-base text-warm-gray-500'>
                Making the world a better place through packaging.
              </p>
            ...
            <div className='mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0'>
              <div className='md:grid md:grid-cols-2 md:gap-8'>
                <div>
                  <h3 className='text-base font-medium text-warm-gray-700'>
                    Solutions
                  </h3>
